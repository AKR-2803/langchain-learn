# ref: [https://docs.google.com/document/d/1qqhSCFIZjI7BdZITazk70pBCWY-pPsyiA2qMxBz2Uqc/]
...
def main():
    ...
    => `|` operator is used to create a new runnable chain that connects the output of the left component to the input of the right component
    => The resulting chain is called a Runnable Object, that means we can invoke it using the invoke() method
    """
